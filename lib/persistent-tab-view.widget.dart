...
class PersistentTabView extends PersistentTabViewBase {
  ...
  PersistentTabView(
    ...
    assert(items.length >= 2 && items.length <= 6,
        "NavBar should have at least 2 or maximum 6");
  }
}
...
class PersistentTabViewBase extends StatefulWidget {
  ...
  ///Hides the navigation bar with an transition animation.
  ...
  ///
  ///If you want to programmatically pop to initial screen on a specific use
  ///this route name when popping.
        ...
        child: PersistentTabScaffold(
          ...
          tabBuilder: (BuildContext context, int index) {
            return SafeArea(
              ...
              right: false,
              left: false,
              bottom: (widget.items[_controller!.index].opacity < 1.0) ||
